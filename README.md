...
Для краткосрочного прогноза мы будем прогнозировать мало точек *(1 - 15 точек, но больше будет распространён формат 1-5 точек)*, для остальных мы будем прогназировать другой формат точек *(5 - 30 точек вперёд в зависимости от типа прогноза)*
